...
let colors_name="mnh_AutumnLeaf"


" Colors for the User Interface.

hi Cursor	guibg=#aa7733   guifg=#ffeebb   gui=bold
hi Normal	guibg=Seashell	guifg=black	gui=none
...
hi IncSearch		guibg=CadetBlue4	guifg=white			gui=bold
...
hi ErrorMsg			guibg=Red3			guifg=white			gui=bold
...
hi Comment guibg=AntiqueWhite guifg=Gray16 gui=italic
...
hi Identifier	guibg=bg    guifg=Brown4 gui=none
...
hi Repeat	guibg=bg    guifg=red3 gui=none
...
hi Special	    guibg=bg	    guifg=DeepPink4    gui=bold
